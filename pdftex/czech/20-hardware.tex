...
Makefile volba \inquotes{WITH\_LCD\_ST7565 = 7920} musí být v každém případě nastavena.
Pro sériový Typ připojení musí být také volba \inquotes{CFLAGS + = -DLCD\_INTERFACE\_MODE=5} zvolená.
