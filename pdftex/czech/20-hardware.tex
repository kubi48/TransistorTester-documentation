...
jsou  \inquotes{pull-up} odpory potřebné, byl dodán další \(27k\Omega\)  odpor na PD7 (Pin 13).
Díky této změně lze vnitřní  \inquotes{Pull-Up} odpory od ATmega vypnout.
...
měli byste instalovat nejméně jeden \inquotes{Pull Up}-odpor R16 na PC4 s hodnotou (\(47k\Omega\)).
...
\centering
  ...
  \color{black}
%  \put(42,25.5){\makebox(0,0)[cb]{tlačítko}}       % Button is signal name in the basic circuit!
...
Displej by ale měl být zapojený,protože jeho \inquotes{Pull-Up} odpory mění napětí.
...
SDA- a SCL-signály musí mít \inquotes{Pull-up} odpor s hodnotou asi \(4,7k\Omega\) k \(3,3V\) .
Možnost připojení je zobrazena na obrázku \ref{fig:ssd1306i2c}.
Před použitím \inquotes{Pull-up} odporů na \(5V\) je nutné zkontrolovat, zda vstupy toto napětí tolerují.
...
Makefile volba \inquotes{WITH\_\discretionary{}{}{}LCD\_\discretionary{}{}{}ST7565 = 7920} musí být v každém případě nastavena.
Pro sériový Typ připojení musí být také volba \inquotes{CFLAGS + = -DLCD\_\discretionary{}{}{}INTERFACE\_\discretionary{}{}{}MODE=5} zvolená.
...
\inquotes{Open Collector} výstupy použít.
Vyžadují se však \inquotes{Pull-Up} odpory nebo se nesmí volba PULLUP\_DISABLE v Makefile použít.
...
Signály I\textsuperscript{2}C-rozhraní vyžadují \inquotes{Pull-Up}-odpor asi \(4,7k\Omega\) na \(3,3V\).
...
Já  jsem analyzoval verzi \inquotes{2.1 2012/11/06} .Zde je chyba v součástce \inquotes{D1},
...
interní \inquotes{Pull-Up} odpory.
Je-li nastavena volba PULLUP\_DISABLE, je pro resetovací signál (PD0) externí \inquotes{Pull-Up} odpor vyžadován.
...
k \inquotes{brown out} resetu procesoru.
...
Také aktivace \inquotes{Brown-Out} detekce procesoru s ATmega pojistkou nepřinesla žádné překvapení.
...
Protože zde dodatečně instalace \inquotes{pull-up} odporu k "vytažení" signálu SPI reset
...
Der \textbf {Testovací pin TP2} má kromě toho funkci výstupu v menu \inquotes{f-Generator}.
