...
The table~\ref{tab:display-con} show the assignment of Port D for different display versions
...
LCD display. 
The following table~\ref{tab:grid-change} shows the modified port pin assignments that enable stripboard layout, 
...
\label{fig:RotEnc}
\end{figure}
The figure~\ref{fig:RotEnc} shows the behavior of two different rotary encoders.
...
\label{fig:RotBounce}
\end{figure}
The figure~\ref{fig:RotBounce} shows a rotary encoder which has not only
